#!/bin/bash
# runner_deep.sh - Full experiment suite for xPatch-GL using 96 lookback
#
# Usage: bash runner_deep.sh
#
...
for pred_len in 96 192 336 720; do
    ...
    python run_gl.py \
        ...
        --patience $PATIENCE \
        --itr 1 \
        2>&1 | tee results_gl_deep/gl_deep_ETTh1_${pred_len}.log
done
...
for pred_len in 96 192 336 720; do
    ...
    python run_gl.py \
        ...
        --patience $PATIENCE \
        --itr 1 \
        2>&1 | tee results_gl_deep/gl_deep_ETTh2_${pred_len}.log
done
...
for pred_len in 96 192 336 720; do
    ...
    python run_gl.py \
        ...
        --patience $PATIENCE \
        --itr 1 \
        2>&1 | tee results_gl_deep/gl_deep_ETTm1_${pred_len}.log
done
...
for pred_len in 96 192 336 720; do
    ...
    python run_gl.py \
        ...
        --patience $PATIENCE \
        --itr 1 \
        2>&1 | tee results_gl_deep/gl_deep_ETTm2_${pred_len}.log
done
...
for pred_len in 96 192 336 720; do
    ...
    python run_gl.py \
        ...
        --patience $PATIENCE \
        --itr 1 \
        2>&1 | tee results_gl_deep/gl_deep_weather_${pred_len}.log
done
...
for pred_len in 96 192 336 720; do
    ...
    python run_gl.py \
        ...
        --patience $PATIENCE \
        --itr 1 \
        2>&1 | tee results_gl_deep/gl_deep_exchange_${pred_len}.log
done
...
echo "----------------"
grep -h "^mse:" results_gl_deep/*.log | head -30
echo ""
echo "Full results in results_gl_deep/"
echo "Parse with: grep 'Final Results\|MSE:' results_gl_deep/*.log"
